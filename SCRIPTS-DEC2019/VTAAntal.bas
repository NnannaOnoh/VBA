...
'  xlSheet.Range("E1") = "Sent To"
  xlSheet.Range("F1") = "Categorie"
  xlSheet.Range("G1") = "In behandeling"
...
'    strColE = objItem.To
    strColF = objItem.Categories
    strColG = objItem.FlagStatus
'    strColH = XLSCount
'    strColI = CSVCount
'    strColJ = HTMCount
'    strColK = DOCCount
